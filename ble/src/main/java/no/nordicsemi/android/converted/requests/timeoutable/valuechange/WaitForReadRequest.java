...
public final class WaitForReadRequest extends TimeoutableRequest.AwaitingRequest<DataSentCallback> implements Operation {
	...
	public WaitForReadRequest(@NonNull final Request.Type type, @Nullable final BluetoothGattCharacteristic characteristic) {
	...
	public WaitForReadRequest(@NonNull final Request.Type type, @Nullable final BluetoothGattDescriptor descriptor) {
	...
	public void setDataIfNull(@Nullable final byte[] data) {
		if (this.data == null)
			this.data = data;
	}
	...
	@NonNull
	@Override
    public WaitForReadRequest setRequestHandler(@NonNull final RequestHandler requestHandler) {
	 ...
	 */
	public void notifyPacketRead(@NonNull final BluetoothDevice device, @Nullable final byte[] data) {
		handler.post(() -> {
