...
public final class Bytes {
	 ...
	 * @return The copy.
	 */
	public static byte[] copy(@Nullable final byte[] value,
	 ...
	 */
	public static byte[] concat(@Nullable final byte[] left, @Nullable final byte[] right, @IntRange(from = 0) final int offset) {
